...
import blackberry.io.filetransfer.ANamespace;
 ...
 *
 */
public class AExt implements WidgetExtension {

    private final static String[] _features = { ANamespace.NAME };
    ...
    public void loadFeature(String feature, String version, Document doc, ScriptEngine scriptEngine) throws Exception {
        if (feature.equals(ANamespace.NAME)) {
            scriptEngine.addExtension(feature, new ANamespace());
        }
    }
